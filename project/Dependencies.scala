...
object Dependencies {
  ...
  val sparkDeltaLakeDependencies: Seq[sbt.ModuleID] = Seq(logback, config, sparkCore, sparkSql, sparkStreaming, sparkSqlKafka, deltaLake)
  val testingDependencies: Seq[sbt.ModuleID] = Seq(scalaTest)
